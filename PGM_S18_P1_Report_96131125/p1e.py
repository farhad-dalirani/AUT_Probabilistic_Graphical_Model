...
# for different king of neighbourhood do MRF
for neighbourhood in ['four', 'eight']:
    print('>    Neighbourhood kind is {}.'.format(neighbourhood))
    #####################################################
    ...
    segmented_img = simulated_anealing(img=img_gaussian_noise, gaussians=conditional_p,
                                         neighbourhood=neighbourhood, beta=1,
    ...
    plt.title('Segmented image-var-{}-neib-{}'.format(variance, neighbourhood))

    mpimg.imsave('output/p1e-1-noisy-image-var-{}-neib-{}.png'.format(variance, neighbourhood), img_gaussian_noise, cmap='gray')
    mpimg.imsave('output/p1e-2-segmented-image-var-{}-neib-{}.png'.format(variance, neighbourhood), segmented_img, cmap='gray')
plt.show()