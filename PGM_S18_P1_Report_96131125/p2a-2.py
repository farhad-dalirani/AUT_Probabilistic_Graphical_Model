...
for key in conditional_p:
    ...
    class_key_pixels = img_noise_free_Hue[regions[key][0]:regions[key][0]+len_of_region,
...
segmented_img = simulated_anealing(img=img_noise_free_Hue, gaussians=conditional_p,
...
mpimg.imsave('output/p2a-hue-1.png', img_noise_free_Hue, cmap='gray')
mpimg.imsave('output/p2a-hue-2-segmented-image.png', segmented_img, cmap='gray')
