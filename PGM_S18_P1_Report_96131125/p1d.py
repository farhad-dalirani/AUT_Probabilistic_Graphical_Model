...
# for different variances, Use MRF to segment noisy image
for variance in [0.009, 0.04, 0.08]:
    ...
    mpimg.imsave('output/p1d-1-noisy-image-var{0}.png'.format(variance), img_gaussian_noise, cmap='gray')
    mpimg.imsave('output/p1d-2-segmented-image-var{0}.png'.format(variance), segmented_img, cmap='gray')
