...
mpimg.imsave('output/p1c-1-noisy-image-var-{}.png'.format(variance), img_gaussian_noise, cmap='gray')
mpimg.imsave('output/p1c-2-segmented-image-var-{}.png'.format(variance), segmented_img, cmap='gray')
plt.show()